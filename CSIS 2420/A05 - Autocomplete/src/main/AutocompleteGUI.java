 ...
 *
 *         * As the user types in a text box, display the top-k terms that start
 *         with the text that the user types.
 *
 *         * Displays the result in a browser if the user selects a term (by
 *         pressing enter, clicking a selection, or pressing the "Search Google"
 *         button).
 *
 *
 ...
 *
 *         NOTE: You will receive a compiler warning in Java 7 (and above). This
 *         is for backward compatibility with Java 6 (because JList was not
 *         retrofitted to support generics until Java 7).
 *
 *
